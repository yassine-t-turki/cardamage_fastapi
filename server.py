...
async def upload_image(request: Request, file: UploadFile = File(...),
    ...
    return await upload_image_wrapper(request, file, threshold_mask, threshold_bbox, label_position, chosen_model)
...
async def rerun_inference(request: Request, filename: str = Form(...),
    ...
    return await rerun_inference_wrapper(request, filename, threshold_mask_rerun, threshold_bbox_rerun, label_position, chosen_model_rerun)
